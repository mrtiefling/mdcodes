...
<nav>
         ...
         <ul>
            ...
            <li><a class="active" href="login.php"><i class="fas fa-user-circle"></i></a></li>
         </ul>
      </nav>
      <style type="text/css">
    body{
                    ...
                    switch($err)
                    {
                        ...
                        ?>
                            <div class="alert-alert-danger">
                                <strong>Fault</strong> incorrect password
                            </div>
                        <?php
                        break;
                        ...
                        ?>
                            <div class="alert-alert-danger">
                                <strong>Fault</strong> incorrect email
                            </div>
                        <?php
                        break;
                        ...
                        ?>
                            <div class="alert-alert-danger">
                                <strong>Fault</strong> non-existent account
                            </div>
                        <?php
                        break;
                    }
...
<form class="box" action="connexion.php" method="post">
 ...
 <input type="email" name="email" class="form-control" placeholder="E-mail" required="required" autocomplete="off">
  ...
  <a class="notyet" href="inscription.php">No account yet ?</a>
</div>
</form>
<script>
